      ...
      <div class="site-navbar-top">
                ...
                <div class="row">
                  <div class="col-md-7 d-flex-justify-content-end">
                    <form action="" class="site-block-top-search">
                      ...
                      <input style="border-radius: 20px;" type="" class="form-control" placeholder="Search">
                    </form>
                  </div>
        ...
        <div class="row mt-5">
          <div class="col-md-3 view overlay zoom">
            <button class="bg-btn"><img src="images/eevee-button.png" class="rounded mx-auto d-block w-50"></button>
          </div>
          <div class="col-md-3 view overlay zoom">
