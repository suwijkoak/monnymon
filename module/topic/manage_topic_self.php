...
?>
<meta charset="UTF-8">
<h1 align="center">กระทู้ของตนเอง</h1>
...
<?php
	echo "<td>
	<a href='index.php?module=tour&action=edit_topic_self_form&top_id=$top_id'><button type='button' class='btn btn-warning' ><i class='fa fa-pencil'></i>&nbsp;</button></a>
	<a href='index.php?module=tour&action=delete_topic_self_single&id=$top_id' onclick='return confirm(\" คุณแน่ใจหรือไม่ ว่าจะลบข้อมูลผู้ใช้นี้ \")'>
