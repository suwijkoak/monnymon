...
<div class="album py-5 bg-light">
    ...
    <a href="add_topic_form.php"><button type="button" class="btn btn-primary"<?php echo $dis; ?>>สร้างกระทู้</button></a>
      <div class="row">
        <?php 
        $topic = mysqli_query($con,"SELECT topic_id,topic_head,topic_pic,topic_time,topic_member FROM topics ORDER BY topic_time DESC;") or die("Sql Topics Error>>".mysqli_error($con));
        while(list($topic_id,$topic_name,$topic_pic,$topic_time,$topic_member)=mysqli_fetch_row($topic)){
        ...
        echo "<img src='images/$topic_pic'  height='200px'>";
